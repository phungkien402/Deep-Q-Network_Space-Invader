...
class DQN(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, fc1_unit=64,
        ...
        # ⚡ FRAME STACKING: 4 frames instead of 1 (document line 1190-1195)
        self.conv1 = nn.Conv2d(4, 32, 8, stride=4, padding=1)  # 4 stacked frames
        self.conv2 = nn.Conv2d(32, 64, 4, stride=2)
        self.conv3 = nn.Conv2d(64, 128, 3)
        self.fc1 = nn.Linear(
            1 * 128 * 19 * 8,
            512)  # flattening frames of 128 kernels, of imgs of size 19x8
    ...
    def forward(self, state):
        ...
        x = state.clone()
        # ⚡ FRAME STACKING: Input shape (batch, 4, 185, 95) - 4 stacked frames
        x = x.view(-1, 4, 185, 95)
